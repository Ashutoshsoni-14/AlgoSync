...
import { Swords, Mail, Lock, Eye, EyeOff, AlertCircle, ArrowRight, Trophy, Users, Shield } from "lucide-react";
    ...
    return (
        <div className="min-h-screen w-full flex flex-col md:flex-row bg-[#070709] text-zinc-150 overflow-hidden font-sans">
            ...
            <div className="w-full md:w-1/2 relative bg-zinc-950 border-r border-zinc-900 flex flex-col justify-between p-12 overflow-hidden shrink-0">
                ...
                <div className="absolute bottom-1/4 right-1/4 translate-x-1/2 translate-y-1/2 w-[400px] h-[400px] rounded-full bg-indigo-500/5 blur-[150px] pointer-events-none" />

                {/* Header Brand */}
                <Link to="/" className="flex items-center gap-2 group relative z-10">
                    <div className="relative flex items-center justify-center w-9 h-9 rounded-lg bg-gradient-to-tr from-amber-500 to-rose-500 shadow-md shadow-amber-500/20 group-hover:scale-105 transition-transform duration-200">
                        <Swords className="w-5 h-5 text-zinc-950 stroke-[2.2]" />
                    </div>
                    <div className="flex flex-col">
                        <span className="text-base font-extrabold tracking-tight bg-gradient-to-r from-amber-400 to-rose-455 bg-clip-text text-transparent">
                            AlgoSync
                        </span>
                ...
                >
                    <div className="mb-8">
                        ...
                        <p className="text-xs text-zinc-500 mt-1.5 font-medium">
                            Enter credentials to access the lobby and matches.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative group">
                                <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-zinc-500 group-focus-within:text-amber-450 transition-colors" />
                                <input
                                    type="email"
                                    name="email"
                                    required
                                    ...
                                    className="w-full pl-10.5 pr-4 py-3 bg-zinc-900/40 border border-zinc-850 focus:border-amber-500/50 focus:ring-1 focus:ring-amber-500/20 rounded-xl text-xs text-zinc-250 placeholder-zinc-700 outline-none transition-all duration-200"
                                />
                            </div>
                        </div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative group">
                                <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-zinc-500 group-focus-within:text-amber-450 transition-colors" />
                                <input
                                    ...
                                    placeholder="••••••••"
                                    onChange={handleChange}
                                    className="w-full pl-10.5 pr-11 py-3 bg-zinc-900/40 border border-zinc-850 focus:border-amber-500/50 focus:ring-1 focus:ring-amber-500/20 rounded-xl text-xs text-zinc-250 placeholder-zinc-700 outline-none transition-all duration-200"
                                />
                                <button
                                    type="button"
                    ...
                    <div className="mt-8 text-center text-xs text-zinc-500 font-medium">
                        ...
                        <Link to="/signup" className="text-amber-400 hover:text-amber-300 font-bold hover:underline transition-colors ml-1">
                            Sign up for free
                        </Link>
                    </div>
                </motion.div>
